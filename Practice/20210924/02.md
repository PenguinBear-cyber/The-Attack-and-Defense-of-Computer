...
```
完成上述編譯過程後，會產生 *test.c*、*test.i*、*test.s*、*test.o* 四種檔案。接下來，即可分別去查看各個檔裡面的內容(cat指令)。

下列指令為檢視 test.i 的檔案內容。(output非常長喔)
```
> cat test.i
```
---
